...
#creation de l'objet    
var twinlewisturret = turret.new("twinlewisturret",0,9,"sim/model/turret[0]/heading","sim/model/turret[0]/pitch",360,0,60,0,70,60);

          
#init de l'objet
var myListener = setlistener("sim/signals/fdm-initialized", func
{
  twinlewisturret.init();
...
# var tourelledetoit = turret.new("TourelledeToit",0,8,"sim/model/turret[0]/heading","sim/model/turret[0]/pitch");
